...
def generate_images(network_pkl, seeds, truncation_psi, dest):
    ...
    for seed_idx, seed in enumerate(seeds):
        ...
        PIL.Image.fromarray(images[0], 'RGB').save(dest + '/{}.png'.format(seed))
...
Run 'python %(prog)s <subcommand> --help' for subcommand help.''',
    ...
    parser_generate_images.add_argument('--dest', help='Root directory for run results (default: %(default)s)', required=True)
